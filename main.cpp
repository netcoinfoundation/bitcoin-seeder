...
static const string mainnet_seeds[] = {"nodes.ghettomining-co.in","", };
static const string testnet_seeds[] = {"nodes.ghettomining-co.in",""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 21310), true);
  }
  do {
